    ...
    public static function showTeachersGroupsController(){
      $data=$_SESSION["user"];    
          ...
          <div id="3'.$group["id_grupo"].'" class="modal modal-fixed-footer" style="height:270px">
            ...
            <div class="modal-footer">
            	<input type="button" value="Print PDF" id="imp" onclick="imprimir('.$group["id_grupo"].');">
            </div>
					</div>';
	    ...
	    public static function finishHourController(){
	    	...
	    	if(isset($_POST["finish"])){
	    		...
	    		if($var==1){
	    			...
	    			$arregloHora = array("hora_entrada"=>$_POST["hora_entrada"],"hora_salida"=>date("H:i:s"),"fecha"=>$_POST["fecha"],"matricula"=>$_POST["matricula"],"actividad"=>$_POST["actividad"]);
