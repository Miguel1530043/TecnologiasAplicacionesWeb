...
<script type="text/javascript">
  ...
  var a = document.getElementById("students").value+"";

  function alumnasGrupo(){
    $('#alumna').empty().trigger("change");
      
      
      var grp = document.getElementById("grupo").value+"";
      var v1 = a.split("%");
      for (var i = 0; i < v1.length-1; i++) {
        var student = v1[i].split(",");
        if(student[2]===grp){
          document.getElementById("alumna").options[document.getElementById("alumna").options.length] = new Option(student[1], student[0]);
          console.log( document.getElementById("alumna").value);
        }  
      }
