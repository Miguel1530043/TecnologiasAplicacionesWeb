<?php
	...
	class Data extends Connection{
		...
		public static function addPaymentModel($data,$table){
			...
			$statement->bindParam(":folio",$data['folio'],PDO::PARAM_STR);
		...
		//Metodo para realizar la consulta que devolvera los datos del pago la cual se desea editar
		...
		//Metodo para editar los datos del pago dependiendo de los datos que se obtenieron en la funcion editPaymentModel.
		...
		//Metodo que realizara la eliminacion del pago dependiendo del id que se haya recibido como parametro
