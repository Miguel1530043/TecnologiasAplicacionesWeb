...
class Data extends Connection{
	...
	public static function addProductModel($data, $table){
		$statement = Connection::connect() -> prepare("INSERT INTO products (id_prod,code,prod_name,date_added,price,stock,category_id) VALUES (NULL,:code,:prod_name,:date_added,:price,:stock,:category_id)");
	...
	public static function addUserModel($data, $table){
		$statement = Connection::connect() -> prepare("INSERT INTO user (firstname,lastname,username,password,email,date_added) VALUES (:firstname,:lastname,:username,:password,:email,:date_added)");
	...
	public static function viewHistorialModel($table){
		$statement = Connection::connect()->prepare("SELECT * FROM $table");
		$statement->execute();
		return $statement->fetchAll();
		$statement->close();
