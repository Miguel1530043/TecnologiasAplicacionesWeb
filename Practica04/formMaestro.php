<?php
  ...
  if(isset($_POST['submit'])){//Se verifica si la variable obtenida 'submit' por el metodo post es Verdadera
    $registro = array('M',$_POST['nEmpleado'],$_POST['nombre'],$_POST['carrera'],$_POST['email'],$_POST['telefono']);//Se crea un arreglo contenedor de una etiqueta y de todos los valores del formulario
    ...
    <div class="row">
      ...
      <div class="large-12 columns" align="center">
        <div class="large-2 columns">
          <a href="menuMaestro.php"><input type="button" name="regresar" value="Back" class="button"></a>
        </div>
        <div class="large-8 columns">
          <h3>Registro de Maestros</h3>
        </div>
        <form method="POST" action="formMaestro.php">
          <input type="text" name="nEmpleado" placeholder="N° de Empleado" required><br>
