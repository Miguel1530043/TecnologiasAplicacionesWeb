...
<div class="row">
    ...
    <div class="col s6" align="center">
      <a href="index.php?action=sesion"><button class="waves-effect waves-light green darken-4 btn modal-trigger btn btn-floating btn-large" style="width:200px;height:200px"><i class="material-icons" style="font-size:80px">av_timer</i>SESSION</button></a>
    </div>
    <div class="col s6" align="center">
      <a href="index.php?action=unidades"><button class="waves-effect waves-light green darken-4 btn modal-trigger btn btn-floating btn-large" style="width:200px;height:200px"><i class="material-icons" style="font-size:80px">donut_small</i>UNITS</button></a>
    </div>
</div>
<?php
  }else{
