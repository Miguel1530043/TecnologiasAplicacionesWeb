<?php
  ...
  if(isset($_POST['modificar'])){//Se condiciona si se hizo el uso del elemento 'modificar'
    ...
    update_user($id,$name);//Se ejecuta la funcion update para actualizar el registro
    header("location: usuarios.php");//Redireccion al apartado de BasketBall
  }
  data_user($id);//Se ejecuta la funcion data para obtener la informacion del jugador
?>
  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="large-9 columns">
        ...
        <a href="Usuarios.php" class="button">Regresar</a>
        <div class="section-container tabs" data-section>
          <form method="POST">
              ...
              <!--Dentro de cada input, es su value se encuentran etiquetas de PHP, en las cuales se utiliza la funcion echo para impresion, dentro de dicha funcion se imprime el resultado de hacer la consulta para obetener los datos del jugador, mediante los parametros que son el id y el deporte, y asi poder mostrar los datos del jugador-->
	            ...
	            <input type="text" name="name" value="<?php echo $result[0]['user_name']?>"></br>
              <input type="password" name="pass" value="<?php echo $result[0]['password']?>" disabled></br>
